...
<body>
    ...
    <table class='info-table'>
        ...
        <tr><td>建立日期</td><td>{data.CreationDate:yyyy-MM-dd HH:mm:ss}</td></tr>
        <tr><td>最後點擊日期</td><td>{data.LastClickDate:yyyy-MM-dd}</td></tr>
    </table>
    ...
    <p><small>最後更新時間: {DateTime.Now:yyyy-MM-dd HH:mm:ss}</small></p>
</body>
</html>";
        }
